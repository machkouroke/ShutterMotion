...
export '/pages/configuration/temp_seuil/temp_seuil_widget.dart'
    show TempSeuilWidget;
export '/pages/configuration/info/info_widget.dart' show InfoWidget;
export '/pages/application/parametre/parametre_widget.dart'
    show ParametreWidget;
