...
import 'temp_seuil_model.dart';
export 'temp_seuil_model.dart';

class TempSeuilWidget extends StatefulWidget {
  const TempSeuilWidget({super.key});

  @override
  State<TempSeuilWidget> createState() => _TempSeuilWidgetState();
}

class _TempSeuilWidgetState extends State<TempSeuilWidget>
